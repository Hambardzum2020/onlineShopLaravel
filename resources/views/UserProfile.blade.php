      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          ...
          <div class="w3-display-bottomleft w3-container w3-text-black">
            <h2 id="color">{{$userData['name']." ".$userData['surname']}}</h2>
          </div>
        </div>
        <div class="w3-container">
          ...
          <p id="color"><i id="iColor" class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>{{$userData['email']}}</p>
